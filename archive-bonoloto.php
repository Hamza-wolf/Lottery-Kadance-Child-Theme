<?php
/**
 * Archive Bonoloto Template (Enhanced)
 * 
 * Template for displaying Bonoloto archive/listing page with modern styling
 */
...
<div class="lottery-archive-container">
    ...
    <div class="lottery-archive-header">
        <h1 class="lottery-archive-title">
            ...
            Bonoloto Results Archive
        </h1>
        <p class="lottery-archive-subtitle">Browse all Bonoloto draw results. Filter by date or search for specific numbers.</p>
    </div>
    ...
    <div class="lottery-archive-grid">
        ...
        <?php else : ?>
            ...
            <div class="no-results">
                ...
                <p>No Bonoloto draws found for the selected criteria.</p>
            </div>
    ...
    <div class="lottery-info-section">
        <div class="lottery-info-grid">
            <div class="lottery-info-card">
                <h3>🎮 How to Play</h3>
                <p>Bonoloto is a popular Spanish lottery game. Choose 6 numbers from 1-49 for a chance to win prizes in multiple categories.</p>
                <a href="#" class="lottery-btn">Learn More</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>🏆 Prize Categories</h3>
                <p>Bonoloto offers multiple prize categories. Match all 6 numbers to win the jackpot, which can reach millions of euros!</p>
                <a href="#" class="lottery-btn">View Prizes</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>📅 Draw Schedule</h3>
                <p>Bonoloto draws take place Monday, Tuesday, Wednesday, Thursday, Friday, and Saturday at 21:30 CET.</p>
