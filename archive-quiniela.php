<?php
/**
 * Archive Quiniela Template (Enhanced)
 * 
 * Template for displaying Quiniela archive/listing page with modern styling
 */
...
<div class="lottery-archive-container">
    ...
    <div class="lottery-archive-header">
        <h1 class="lottery-archive-title">
            ...
            La Quiniela Results Archive
        </h1>
        <p class="lottery-archive-subtitle">Browse all Quiniela football pool results. Filter by date or search for specific matches.</p>
    </div>
    ...
    <div class="lottery-archive-grid">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="lottery-archive-card">
                    ...
                    <div class="card-body">
                        ...
                        for ($i = 1; $i <= 14; $i++) {
                            $result = get_post_meta(get_the_ID(), '_match_' . $i . '_result', true);
                            if ($result == '1') $home_wins++;
                            elseif ($result == 'X') $draws++;
                            elseif ($result == '2') $away_wins++;
                        }
                        ?>
                        ...
                        <div class="match-summary">
                            <div class="summary-item">
                                ...
                                <div class="summary-value summary-home"><?php echo $home_wins; ?></div>
                            </div>
                            <div class="summary-item">
                                <div class="summary-label">Draws</div>
                                <div class="summary-value summary-draw"><?php echo $draws; ?></div>
                            </div>
                            <div class="summary-item">
                                <div class="summary-label">Away Wins</div>
                                <div class="summary-value summary-away"><?php echo $away_wins; ?></div>
                            </div>
                        </div>
                        ...
                        <div class="quiniela-matches">
                            <table class="quiniela-table">
                                ...
                                <tbody>
                                    <?php 
                                    // Display first 8 matches for preview
                                    for ($i = 1; $i <= 8; $i++) :
                                        ...
                                        if ($home_team && $away_team) : 
                                            ...
                                            <tr>
                                                ...
                                                <td class="result">
                                                    <div class="<?php echo $result_class; ?>"><?php echo esc_html($result); ?></div>
                                                </td>
                                            </tr>
                                        <?php endif;
                                    endfor; ?>
                                    
                                    <?php if ($home_wins + $draws + $away_wins > 8) : ?>
                                    <tr>
                                        <td colspan="3" style="text-align: center; padding: 15px; color: #6c757d; font-style: italic;">
                                            ... and <?php echo ($home_wins + $draws + $away_wins - 8); ?> more matches
                                        </td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                        ...
                        <a href="<?php the_permalink(); ?>" class="view-details-btn">👁️ View All 14 Matches</a>
                    </div>
                </div>
        ...
        <?php else : ?>
            ...
            <div class="no-results">
                ...
                <p>No Quiniela draws found for the selected criteria.</p>
            </div>
    ...
    <div class="lottery-info-section">
        <div class="lottery-info-grid">
            <div class="lottery-info-card">
                <h3>🎮 How to Play</h3>
                <p>La Quiniela is Spain's football pool betting game. Predict the outcomes of 14 football matches (1 for home win, X for draw, 2 for away win) for a chance to win prizes.</p>
                <a href="#" class="lottery-btn">Learn More</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>🏆 Prize Categories</h3>
                <p>Quiniela offers multiple prize categories based on how many matches you correctly predict. Match all 14 results to win the top prize!</p>
                <a href="#" class="lottery-btn">View Prizes</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>📅 Draw Schedule</h3>
                <p>Quiniela draws take place weekly during the football season, typically on weekends. Check back for the latest results!</p>
...
function searchTeam() {
    ...
    alert(`Searching for matches with team: "${teamName}"\n\nThis would search through all Quiniela draws to find matches involving this team.`);
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add autocomplete suggestions for common teams (you can expand this)
