<?php
/**
 * Archive Primitiva Template (Enhanced)
 * 
 * Template for displaying Primitiva archive/listing page with modern styling
 */
...
<div class="lottery-archive-container">
    ...
    <div class="lottery-archive-header">
        <h1 class="lottery-archive-title">
            ...
            La Primitiva Results Archive
        </h1>
        <p class="lottery-archive-subtitle">Browse all La Primitiva draw results. Filter by date or search for specific numbers.</p>
    </div>
    ...
    <div class="lottery-archive-grid">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="lottery-archive-card">
                    ...
                    <div class="card-body">
                        <div class="winning-numbers-display">
                            ...
                            <div class="lottery-numbers">
                                ...
                                if (is_array($numbers) && !empty($numbers)) {
                                    ...
                                    foreach (array_slice($number_array, 0, 6) as $number) {
                        ...
                        <?php 
                        $complementary = get_post_meta(get_the_ID(), '_complementary_number', true);
                        if ($complementary) : ?>
                        <div class="complementary-section">
                            <div class="numbers-label">Complementary:</div>
                            <div class="number-ball complementary-ball"><?php echo esc_html($complementary); ?></div>
                        </div>
                        <?php endif; ?>
                        ...
                        if ($reintegro) : ?>
                        <div class="reintegro-section">
                            <div class="numbers-label">Reintegro:</div>
                            <div class="number-ball reintegro-ball"><?php echo esc_html($reintegro); ?></div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="card-info">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value jackpot-value">€<?php echo number_format($jackpot, 0); ?></div>
                            </div>
                            <?php endif; ?>
        ...
        <?php else : ?>
            ...
            <div class="no-results">
                ...
                <p>No La Primitiva draws found for the selected criteria.</p>
            </div>
    ...
    <div class="lottery-info-section">
        <div class="lottery-info-grid">
            <div class="lottery-info-card">
                <h3>🎮 How to Play</h3>
                <p>La Primitiva is one of Spain's most popular lotteries. Choose 6 numbers from 1-49 and a complementary number for a chance to win big prizes.</p>
                <a href="#" class="lottery-btn">Learn More</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>🏆 Prize Categories</h3>
                <p>La Primitiva offers multiple prize categories. Match all 6 numbers to win the jackpot, which can reach millions of euros!</p>
                <a href="#" class="lottery-btn">View Prizes</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>📅 Draw Schedule</h3>
                <p>La Primitiva draws take place every Thursday and Saturday at 21:00 CET. Don't miss your chance to play!</p>
