<?php
/**
 * Archive EuroDreams Template (Enhanced)
 * 
 * Template for displaying EuroDreams archive/listing page with modern styling
 */
...
<div class="lottery-archive-container">
    ...
    <div class="lottery-archive-header">
        ...
        <p class="lottery-archive-subtitle">Browse all EuroDreams draw results. Filter by date or search for specific numbers.</p>
    </div>
    ...
    <div class="lottery-archive-grid">
                ...
                <div class="lottery-archive-card">
                    ...
                    <div class="card-body">
                        <div class="winning-numbers-display">
                            <div class="numbers-label">Main Numbers:</div>
                        ...
                        <div class="dream-section">
                            <div class="numbers-label">Dream Number:</div>
                            <div class="number-ball dream-ball"><?php echo esc_html($dream_number); ?></div>
                        </div>
                        <?php endif; ?>
                        
                        <div class="card-info">
                            <div class="info-item">
                                <div class="info-label">Monthly Prize</div>
                                <div class="info-value monthly-prize">€20,000</div>
                            </div>
        ...
        <?php else : ?>
            ...
            <div class="no-results">
                ...
                <p>No EuroDreams draws found for the selected criteria.</p>
            </div>
    ...
    <div class="lottery-info-section">
        <div class="lottery-info-grid">
            <div class="lottery-info-card">
                <h3>🎮 How to Play</h3>
                <p>EuroDreams is a new European lottery game. Choose 6 main numbers from 1-40 and 1 dream number from 1-5 for a chance to win monthly payments for up to 30 years.</p>
                <a href="#" class="lottery-btn">Learn More</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>🏆 Monthly Prizes</h3>
                <p>EuroDreams offers multiple prize categories. Match all 6 main numbers plus the dream number to win €20,000 per month for 30 years!</p>
                <a href="#" class="lottery-btn">View Prizes</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>📅 Draw Schedule</h3>
                <p>EuroDreams draws take place every Monday and Thursday at 21:00 CET. Don't miss your chance to play!</p>
