<?php
/**
 * Archive Lototurf Template (Enhanced)
 * 
 * Template for displaying Lototurf archive/listing page with modern styling
 */
...
<div class="lottery-archive-container">
    ...
    <div class="lottery-archive-header">
        <h1 class="lottery-archive-title">
            ...
            Lototurf Results Archive
        </h1>
        <p class="lottery-archive-subtitle">Browse all Lototurf draw results. Filter by date or search for specific numbers.</p>
    </div>
    ...
    <div class="lottery-archive-grid">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <div class="lottery-archive-card">
                    ...
                    <div class="card-body">
                        ...
                        <?php 
                        $horse_number = get_post_meta(get_the_ID(), '_horse_number', true);
                        if ($horse_number) : ?>
                        <div class="horse-section">
                            <div class="numbers-label">Horse Number:</div>
                            <div class="number-ball horse-ball"><?php echo esc_html($horse_number); ?></div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="card-info">
                            <div class="info-item">
                                ...
                                <div class="info-value">Horse Racing</div>
                            </div>
        ...
        <?php else : ?>
            ...
            <div class="no-results">
                ...
                <p>No Lototurf draws found for the selected criteria.</p>
            </div>
    ...
    <div class="lottery-info-section">
        <div class="lottery-info-grid">
            <div class="lottery-info-card">
                <h3>🎮 How to Play</h3>
                <p>Lototurf is a Spanish lottery game with a horse racing theme. Choose 6 numbers from 1-31 and a horse number from 1-12 for a chance to win prizes.</p>
                <a href="#" class="lottery-btn">Learn More</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>🏆 Prize Categories</h3>
                <p>Lototurf offers multiple prize categories. Match all 6 numbers plus the horse number to win the jackpot!</p>
                <a href="#" class="lottery-btn">View Prizes</a>
            </div>
            
            <div class="lottery-info-card">
                <h3>📅 Draw Schedule</h3>
                <p>Lototurf draws take place every Sunday. Check back for the latest results!</p>
